    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="relative h-full flex-grow overflow-hidden rounded-full bg-gray-500">
              <div
      ...
      <p className="absolute font-montserrat-medium text-gray-900 transform -translate-y-4 text-xs font-bold tracking-wide">
        {Math.round(value)}
      </p>
    </>
  );
