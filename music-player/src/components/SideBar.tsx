...
function SideBar() {
    return (
        <div className="sidebar w-2xs h-screen bg-[#605c5b] backdrop-blur-lg border-r text-[#eeebea] pl-10 pt-4 shadow-xl">
            ...
            <ul className="sidebar-menu pt-5 text-xl font-light text-[#eeebea]">
            ...
            <ul className="sidebar-menu pt-5 font-light text-xl text-[#eeebea]">
                <li className="menu-item hover:backdrop-blur-md hover:bg-[#3d3b3b] hover:text-[#cdd084] transition-all rounded-full w-40 cursor-pointer hover:shadow-lg p-3">Recently Played</li>
                <li className="menu-item hover:backdrop-blur-md hover:bg-[#3d3b3b] hover:text-[#cdd084] transition-all rounded-full w-40 cursor-pointer hover:shadow-lg p-3">Favorite Songs</li>
