...
function SideBar({collapsed, setCollapsed}: SideBarProps) {
    ...
    return (
        ...
        <div className={`fixed top-0 left-0 z-40 h-full bg-gray-00 rounded-r-4xl xl:rounded-r-none border border-gray-300/50 backdrop-blur-xl xl:backdrop-blur-none xl:bg-gray-300 text-black pt-4 shadow-xl w-64 transition-all ease-in-out duration-500 xl:static xl:translate-x-0  ${collapsed ? '-translate-x-full xl:translate-x-0' : 'translate-x-0'}`}>
